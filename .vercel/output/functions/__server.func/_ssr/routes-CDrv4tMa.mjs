...
import { BG_LANDSCAPE, Route$3 } from "./router-CPdvURjx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CDrv4tMa.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
					className: "cover__names display-hero",
					children: [
						WEDDING.brideName,
						" ",
					...
					className: "cover__date body--lg fade-in-up delay-300",
