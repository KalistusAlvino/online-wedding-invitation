...
import { require_jsx_runtime, require_react, require_react_dom } from "./react-devtools+[...].mjs";
...
//#endregion
export { GLOBAL_TSR, HeadContent, RouterProvider, Scripts, TSR_SCRIPT_BARRIER_ID, _getRenderedMatches, bindSsrResponseToRequest, createFileRoute, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createLRUCache, createRootRoute, createRouter, decodePath, defineHandlerCallback, dehydrateSsrMatchId, disposeSsrResponseDetached, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, lazyRouteComponent, normalizeSsrResponse, renderRouterToStream, replaceSsrResponse, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody, useNavigate };
