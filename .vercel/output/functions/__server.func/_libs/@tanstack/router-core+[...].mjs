import { GLOBAL_TSR, TSR_SCRIPT_BARRIER_ID, _getRenderedMatches, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createLRUCache, decodePath, dehydrateSsrMatchId, getStylesheetHref, invariant, rootRouteId } from "./react-router+[...].mjs";
...
//#endregion
export { attachRouterServerSsrUtils, createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, fromJSON, getNormalizedURL, getOrigin, makeSerovalPlugin, mergeHeaders, toCrossJSONAsync, toCrossJSONStream, waitForRequest };
